...
class MeshDrawer {
	...
	constructor() {
		// "setMesh" Initialization: Create the vertex buffer and the texture coordinate buffer;
	...
	setMesh(vertPos, texCoords) {
		...
		this.numTriangles = vertPos.length / 3;	// number of vertex/3 = number of triangles
	}
